...
dependencies {
    ...
    implementation("androidx.wear.protolayout:1.1.0-alpha02")
    implementation("androidx.wear.protolayout-material:1.1.0-alpha02")
    implementation("androidx.wear.protolayout-expression:1.1.0-alpha02")
